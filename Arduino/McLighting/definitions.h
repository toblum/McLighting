...
//
//#define OFFSET         // If defined, first led of starting effect like dual scan,scan etc, is traslated of OFFSET number of leds. Not use this in conjuction of USE_WS2812FX_DMA,USE_WS2812FX_UART1 or USE_WS2812FX_UART2 
