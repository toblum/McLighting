...
#define LED_PIN 3                    // PIN (2 / D4) where neopixel / WS2811 strip is attached
...
///////// McLighting Settings //////////
#define HOSTNAME "McLighting01"    // Name that shows up on WiFi router once connected to STATION_SSID

#define USE_MCLIGHTING_UI
...
/////// Enter WiFi Settings if you have them, taken care of in WiFiManager ///////////
...
#endif
#if !defined(USE_NEOANIMATIONFX) and !defined(USE_WS2812FX)
#error "Need to either use NeoAnimationFX or WS2812FX mode."
#endif
